...
module.exports = (app) => {
  ...
  app.route("/users/:id").all(app.config.passport.authenticate()).get(adminMiddleware(app.api.user.getById)).put(adminMiddleware(app.api.user.save)).delete(adminMiddleware(app.api.user.remove))
